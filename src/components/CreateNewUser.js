      ...
      return (
        <div>
          <form action="" className="form-inline" onSubmit={this.onSubmit.bind(this)}>
            <div>
              <div>
                <input type="text" className="form-control" placeholder="           First name " onChange={this.addFirstName} />
              </div>
              <div>
                <input type="text" className="form-control" placeholder="           Last name " onChange={this.addLastName}/>
              </div>
               <div>
                <input type="email" className="form-control" placeholder="              Email " onChange={this.addEmail}/>
              </div>
              <div>
                <input type="password" className="form-control" placeholder="           Password " onChange={this.addPassword}/>
              </div>
