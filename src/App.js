...
import AudioAnalyzer from './components/AudioAnalyser'
...
export default class App extends Component {
  ...
  render() {
    if (this.state.showArtistTable) {
      let {data} = this.state
      let artistCardComponents = data.map((tracks) => {
        return (
          <ArtistCard
            tracks={tracks}
      ...
      return (
        <div className="App">
          ...
          <div className="container">
            ...
            {
              !this.state.loggedIn &&
              <LoginForm loginTrue={this.loginTrue.bind(this)}
                hasAccount={this.hasAccount.bind(this)}
              />
            }
            {
